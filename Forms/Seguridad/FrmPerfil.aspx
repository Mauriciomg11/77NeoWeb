            ...
            <asp:Panel ID="PnlPerfil" runat="server" Visible="false">
                ...
                <div class="DivGridPerfilAsig DivContendorGrid">
                    <asp:GridView ID="GrdPerfilAsig" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="false" DataKeyNames="CodidUsrPerfil"
                        CellPadding="3" CssClass="GridControl DiseñoGrid table table-sm" GridLines="Both" AllowPaging="true" PageSize="6" OnPageIndexChanging="GrdPerfilAsig_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="IbtDelete" CssClass="BotonDeleteGrid" ImageUrl="~/images/deleteV3.png" runat="server" CommandName="Delete" ToolTip="Retirar" OnClientClick="javascript:return confirm('¿Está seguro de querer eliminar el registro seleccionado?', 'Mensaje de sistema')" />
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <div class="DivGridPerfilSinAsig DivContendorGrid">
                    <asp:GridView ID="GrdSinAsig" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="false" DataKeyNames="CodIdFormulario"
                        CellPadding="3" CssClass="GridControl DiseñoGrid table table-sm" GridLines="Both" AllowPaging="true" PageSize="7" OnPageIndexChanging="GrdSinAsig_PageIndexChanging"
