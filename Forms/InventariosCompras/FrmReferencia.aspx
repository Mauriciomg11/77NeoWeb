...
<asp:Content ID="Content2" ContentPlaceHolderID="EncScriptDdl" runat="server">
    <script type="text/javascript">
        function myFuncionddl() {
            ...
            $('[id*=DdlManPP],[id*=DdlUMComPP],[id*=DdlUMCom]').chosen();//[id*=DdlEstPNPP],[id*=DdlEstPN],
        }
    </script>
</asp:Content>
                    ...
                    <div class=" CentrarTable ">
                        <table class="TablaCampos table table-sm">
                            <tr>
                                ...
                                <td width="25%">
                                    <asp:DropDownList ID="DdlAta" runat="server" Font-Size="8" Enabled="false" OnTextChanged="DdlAta_TextChanged" AutoPostBack="true" />
                                </td>
            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="PnlCambioRef" runat="server" Visible="false">
                    ...
                    <div class="DivContendorGrid">
                        <%--DivGridCamRef DivContendorGrid--%>
