                    ...
                    <asp:Table ID="TblCampos" runat="server">
                        <asp:TableRow>
                            ...
                            <asp:TableCell Width="9%">
                                ...
                                <asp:TextBox ID="TxtFecFabr" runat="server" CssClass="form-control-sm heightCampo" Enabled="false" Width="35%" Font-Size="11px" />
                            ...
                            <asp:TableCell Width="3%">
                                <asp:CheckBox ID="CkbAdmon" runat="server" CssClass="LblEtiquet" Text="" Enabled="false" />
                            </asp:TableCell>
