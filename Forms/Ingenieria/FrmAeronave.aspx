    ...
    <asp:MultiView ID="MlVwCampos" runat="server">
        <asp:View ID="Vw0LibroVuelo" runat="server">
            <asp:UpdatePanel ID="UpPlHk" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Label ID="LblBusqHK" runat="server" CssClass="LblEtiquet" Text="Seleccionar una Aeronave:"></asp:Label>
                    <asp:DropDownList ID="DdlBusqHK" runat="server" CssClass="Campos" OnTextChanged="DdlBusqHK_TextChanged" AutoPostBack="true" Width="20%"></asp:DropDownList>
                    <asp:Label ID="LblCodHK" runat="server" CssClass="LblEtiquet" Text="Código:"></asp:Label>
                    ...
                    <h6 class="TextoSuperior">
                        <asp:Label ID="LblTitCampos" runat="server" Text="Datos Aeronave"></asp:Label></h6>
                    <%--<div style="overflow-x: auto;">--%>
                        <asp:Table ID="TblCampos" runat="server">
                            <asp:TableRow>
                                ...
                                <asp:TableCell Width="7%">
                                    <asp:Label ID="LblSn" runat="server" CssClass="LblEtiquet" Text="S/N:"></asp:Label>&nbsp
                                    <asp:TextBox ID="TxtSn" runat="server" CssClass="form-control-sm heightCampo" MaxLength="50" Enabled="false" Width="70%"></asp:TextBox>
                                </asp:TableCell>
                                <asp:TableCell Width="8%">
                                    <asp:Label ID="LblCCosto" runat="server" CssClass="LblEtiquet" Text="C. Costo:"></asp:Label>&nbsp&nbsp&nbsp&nbsp
                                    <asp:DropDownList ID="DdlCcosto" runat="server" CssClass="heightCampo" Enabled="false" Width="100%"></asp:DropDownList>
                                </asp:TableCell>
                                <asp:TableCell Width="9%">
                                    ...
                                    <asp:TextBox ID="TxtFecFabr" runat="server" CssClass="form-control-sm heightCampo" Enabled="false" Width="35%" Font-Size="11px"></asp:TextBox>
                                ...
                                <asp:TableCell Width="3%">
                                    <asp:CheckBox ID="CkbAdmon" runat="server" CssClass="LblEtiquet" Text="" Enabled="false" />&nbsp
                                    <asp:Label ID="LblAdmon" runat="server" CssClass="LblEtiquet" Text="Administrada" />
                                </asp:TableCell>
                                <asp:TableCell Width="5%">
                                    <asp:CheckBox ID="CkbPropiedad" runat="server" CssClass="LblEtiquet" Text="" Enabled="false" />&nbsp
                                    <asp:Label ID="Label1" runat="server" CssClass="LblEtiquet" Text="Es de Propiedad" />
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="LblModelo" runat="server" CssClass="LblEtiquet" Text="Modelo:"></asp:Label>&nbsp&nbsp&nbsp
                                    <asp:DropDownList ID="DdlModelo" runat="server" CssClass="heightCampo" Enabled="false" Width="100%"></asp:DropDownList>
                                </asp:TableCell>
                                <asp:TableCell>
                                    <asp:Label ID="LblTipo" runat="server" CssClass="LblEtiquet" Text="Tipo:"></asp:Label>&nbsp
                                    <asp:DropDownList ID="DdlTipo" runat="server" CssClass="heightCampo" Enabled="false" Width="100%"></asp:DropDownList>
                                </asp:TableCell>
                                <asp:TableCell>
                                    <asp:Label ID="LblPropie" runat="server" CssClass="LblEtiquet" Text="Propietario:"></asp:Label>&nbsp
                                    <asp:DropDownList ID="DdlPropie" runat="server" CssClass="heightCampo" Enabled="false" Width="80%"></asp:DropDownList>
                                </asp:TableCell>
                                <asp:TableCell ColumnSpan="2">
                                    <asp:Label ID="LblEstado" runat="server" CssClass="LblEtiquet" Text="Estado:"></asp:Label>&nbsp
                                    <asp:DropDownList ID="DdlEstado" runat="server" CssClass="heightCampo" Enabled="false" Width="50%"></asp:DropDownList>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableHeaderRow>
