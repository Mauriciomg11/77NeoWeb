                        ...
                        <asp:GridView ID="GrdHistor" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" DataKeyNames="CodigoIdHistoricoAeronaveVirtual,CodAeronave"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Fecha evento" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:Label ID="LblFecEvP" Text='<%# Eval("FechaMontajeMDY") %>' runat="server" Width="70%" Enabled="false" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TxtFecEv" Text='<%# Eval("FechaMontaje") %>' runat="server" Width="100%" TextMode ="Date" />                                       
                                    </EditItemTemplate>
                                </asp:TemplateField>
