<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmEntradaRecuperacion.aspx.cs" Inherits="_77NeoWeb.Forms.Almacen.FrmEntradaRecuperacion" %>
                ...
                <asp:View ID="Vw0Datos" runat="server">
                    <div class="CentrarCntndr">
                        <div id="Aeronave-Observacion" class="row">
                            ...
                            <div id="Aeronave" class="col-sm-3">
                                <asp:Label ID="LblAeronave" runat="server" CssClass="LblEtiquet" Text="aeronave" />
                                <asp:DropDownList ID="DdlAeronave" runat="server" CssClass="heightCampo" Width="100%" OnTextChanged="DdlAeronave_TextChanged" AutoPostBack="true" />
                            </div>
                        ...
                        <div id="PN-SN" class="row">
                            <div id="PN" class="col-sm-2">
                            ...
                            <div id="SN" class="col-sm-2">
                                <asp:Label ID="LblSN" runat="server" CssClass="LblEtiquet" Text="S/N" />
                                <asp:DropDownList ID="DdlSN" runat="server" CssClass="heightCampo" Width="100%" OnTextChanged="DdlSN_TextChanged" AutoPostBack="true" />
                            </div>
                        </div>
                        <div class="row">
                            <div id="GridDetRecup" class="col-sm-12">
                                ...
                                <div class="ScrollGrid pre-scrollable">
                                    <asp:GridView ID="GrdDtlleRecup" runat="server" EmptyDataText="No existen registros ..!" AutoGenerateColumns="false"
                                        DataKeyNames="CodElemHAV, CodReferencia, CCosto, CodUbicaBodega, CodTercero,PorcentajeRecup,CodTipoElemento, IdentificadorElemR,CodUndMedR,
                                                        Bloquear,CodIdUbicacion, CodMoneda"
                                        CssClass="GridControl DiseñoGrid table-sm" GridLines="Both" OnRowCommand="GrdDtlleRecup_RowCommand" OnRowDataBound="GrdDtlleRecup_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ubictec">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblUbcTec" Text='<%# Eval("CodUbicacionFisicaH") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="pos">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblPos" Text='<%# Eval("PosicionI") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="P/N">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="fecha remocion">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblfecRem" Text='<%# Eval("FechaRemc") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="motivo remocion">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblMotv" Text='<%# Eval("MotivoRemocion") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <HeaderStyle CssClass="GridCabecera" />
                 ...
                 <asp:View ID="Vw1Asignar" runat="server">
                    ...
                    <h6 class="TextoSuperior">
                        <asp:Label ID="LblTitAsigFis" runat="server" Text="recuperar elemento" />
                    </h6>
                    <div class="CentrarCntndr">
                        <br />
                        <div class="row">
                                ...
                                <div class="ScrollRsva pre-scrollable">                                   
                                    <asp:GridView ID="GrdAsignar" runat="server" EmptyDataText="No existen registros ..!" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="cant recuperada">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="bodega destino" HeaderStyle-Width="35%">
                                                <ItemTemplate>
