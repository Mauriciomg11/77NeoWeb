...
{
    public partial class FrmAlertaSolicitudNuevaRepa : System.Web.UI.Page
    {
        ...
        protected void BindModal()
        {
            ...
            {
                string VbTxtSql = "EXEC Consultas_General_Logistica 39,'','','',0, 0 ,@ICC,'01-01-1','01-01-1'";
        ...
        protected void BtnExportarModl_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CursorIdioma.Alimentar("CurExportAlertSolPedRep", Session["77IDM"].ToString().Trim());
                StSql = "EXEC Consultas_General_Logistica 39,'CurExportAlertSolPedRep','','WEB',1, @Idm,@ICC,'01-01-1','01-01-1'";
