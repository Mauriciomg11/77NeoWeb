<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmReintegroMatComp.aspx.cs" Inherits="_77NeoWeb.Forms.Almacen.FrmReintegroMatComp" %>
                    ...
                    <div class="CentrarCntndr">
                        <div class="row">
                            <%--  <div class="col-sm-3">
                                ...
                                <asp:DropDownList ID="DdlAlmacen" runat="server" CssClass="heightCampo" Width="100%" Enabled="false" />
                            </div>--%>
                            <div class="col-sm-3">
                                <asp:Label ID="LblAeronave" runat="server" CssClass="LblEtiquet" Text="aeronave" />
                                <asp:DropDownList ID="DdlAeronave" runat="server" CssClass="heightCampo" Width="100%" Enabled="false" />
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="ScrollRsva pre-scrollable">
                                    <asp:GridView ID="GrdDtllRitgr" runat="server" EmptyDataText="No existen registros ..!" AutoGenerateColumns="false" DataKeyNames="CodIdDetalleRes,Estado"
                                        CssClass="GridControl DiseñoGrid table-sm" GridLines="Both" OnRowCommand="GrdDtllRitgr_RowCommand" OnRowDataBound="GrdDtllRitgr_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Select">
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="UplAbrir" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:ImageButton ID="IbtAbrir" Width="30px" Height="30px" ImageUrl="~/images/ReportV1.png" runat="server" CommandName="Abrir" ToolTip="seleccionar para el reintegro" />
                                                        </ContentTemplate>
                                                        <Triggers>
                                            ...
                                            <asp:TemplateField HeaderText="cant reintegro">
                                                <ItemTemplate>
                        ...
                        <div class="col-sm-8 Interna">
                            <div class="ScrollRsva pre-scrollable">
                                ...
                                <asp:GridView ID="GrdUbicaFisc" runat="server" EmptyDataText="No existen registros ..!" AutoGenerateColumns="false"
                                    DataKeyNames="CodElemento,CodUbicaBodega, CodTercero, CodReferencia, IdentificadorElemR, Activo, CodEstadoPn, CodIdAlmacen, Ccosto, IdPropuesta,
                                                    CodIdDocumento, CodUsuarioReserva,CodIdDetalleSalida"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="almacen">
                                            <ItemTemplate>
                                                <asp:Label ID="LblNomAlma" Text='<%# Eval("NomAlmacen") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="cant despachada">
                                            <ItemTemplate>
                                                <asp:Label ID="LblCantEntregada" Text='<%# Eval("Cantidad") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="cant reitegro">
                                            <ItemTemplate>
                            ...
                            <div class="ScrollRsva pre-scrollable">
                                ...
                                <asp:GridView ID="GrdVisualizar" runat="server" EmptyDataText="No existen registros ..!" AutoGenerateColumns="false" DataKeyNames="CodIdDetalleRes"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="almacen">
                                            <ItemTemplate>
                                                <asp:Label ID="LLblNomAlma" Text='<%# Eval("NomAlma") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="bodega">
                                            <ItemTemplate>
