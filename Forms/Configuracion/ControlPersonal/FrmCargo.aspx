                    ...
                    <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="CodCargo"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Descripción" HeaderStyle-Width="40%">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="TxtNomTPP" runat="server" MaxLength="200" Width="100%" />
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Tripulante">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Genera Reporte">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Despacho Reserva">
                                <ItemTemplate>
