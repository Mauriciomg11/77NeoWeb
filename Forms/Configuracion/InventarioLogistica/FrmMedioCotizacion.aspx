<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmMedioCotizacion.aspx.cs" Inherits="_77NeoWeb.Forms.Configuracion.InventarioLogistica.FrmMedioCotizacion" %>
        ...
        <ContentTemplate>
            <div class="CentrarTable">
                ...
                <div class="DivGrid DivContendorGrid">
                    <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="CodMedioCotiza"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Cód" HeaderStyle-Width="10%">
                                <ItemTemplate>
                                    <asp:Label Text='<%# Eval("CodMedioCotiza") %>' runat="server" Width="100%" />
                                </ItemTemplate>
                            </asp:TemplateField>
