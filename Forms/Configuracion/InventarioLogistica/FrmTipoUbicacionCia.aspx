<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmTipoUbicacionCia.aspx.cs" Inherits="_77NeoWeb.Forms.Configuracion.InventarioLogistica.FrmTipoUbicacionCia" %>
        ...
        <ContentTemplate>
            <div class="CentrarTable">
                ...
                <div class="DivGrid DivContendorGrid">
                    <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="CodIdTipoUbicaCia"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Cód" HeaderStyle-Width="10%">
                                <ItemTemplate>
                                    <asp:Label Text='<%# Eval("CodIdTipoUbicaCia") %>' runat="server" Width="50px" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="TipoU" HeaderStyle-Width="5%">
                                <ItemTemplate>
                                    <asp:Label ID="LblTipoUP" Text='<%# Eval("TipoUbicacion") %>' runat="server" Width="100%" />
                                </ItemTemplate>
                                <EditItemTemplate>
