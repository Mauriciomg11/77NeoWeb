<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmFabricante.aspx.cs" Inherits="_77NeoWeb.Forms.Configuracion.InventarioLogistica.FrmFabricante" %>
        ...
        <ContentTemplate>
            <div class="CentrarTable">
                ...
                <div class="DivGrid DivContendorGrid">
                    <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="IdFabricante, CodFabricante"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Cód">
                                <ItemTemplate>
                                    <asp:Label Text='<%# Eval("CodFabricante") %>' runat="server" Width="50px" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Descripc" HeaderStyle-Width="40%">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TxtDesc" Text='<%# Eval("Nombre") %>' runat="server" MaxLength="200" Width="100%" />
                                </EditItemTemplate>
                                <FooterTemplate>
