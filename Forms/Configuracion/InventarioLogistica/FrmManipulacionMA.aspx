<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmManipulacionMA.aspx.cs" Inherits="_77NeoWeb.Forms.Configuracion.InventarioLogistica.FrmManipulacionMA" %>
        ...
        <ContentTemplate>
            <div class="CentrarTable">
                ...
                <div class="DivGrid DivContendorGrid">
                    <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="IdCondicionManipulacion, CodManipulacion"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Cód">
                                <ItemTemplate>
                                    <asp:Label Text='<%# Eval("CodManipulacion") %>' runat="server" Width="50px" />
                                </ItemTemplate>
                            </asp:TemplateField>
