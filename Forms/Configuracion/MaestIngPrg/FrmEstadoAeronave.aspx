<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTransac.Master" AutoEventWireup="true" CodeBehind="FrmEstadoAeronave.aspx.cs" Inherits="_77NeoWeb.Forms.Configuracion.MaestIngPrg.FrmEstadoAeronave" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>EstadoAeronave</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CuerpoPagina" runat="server">
    <asp:UpdatePanel ID="UpPanel" runat="server">
        <ContentTemplate>
            <table class="TablaBusqueda content">
                <tr>
                    <td>
            ...
            <div class="DivGrid DivContendorGrid">
                <asp:GridView ID="GrdDatos" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" ShowFooter="true" DataKeyNames="IdEstadoAeronave,CodEstadoAeronave"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Código">
                            <ItemTemplate>
                                <asp:Label Text='<%# Eval("CodEstadoAeronave") %>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Descripción">
                            ...
                            <FooterTemplate>
                                <asp:TextBox ID="TxtDescPP" runat="server" Width="350px" />
                            </FooterTemplate>
                        </asp:TemplateField>
