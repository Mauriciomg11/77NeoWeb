    ...
    public class ClsUbicaGeograf
    {
        ...
        public void Alimentar(IEnumerable<ClsUbicaGeograf> oUbicacionGeografica)
        {
            ...
            catch (Exception Ex)
            {
                ...
                Cnx.UpdateErrorV2(VbUsu, VbPantalla, "ClsUbicaGeograf", Ex.StackTrace.Substring(Ex.StackTrace.Length > 300 ? Ex.StackTrace.Length - 300 : 0, 300), Ex.Message, VbcatVer, VbcatAct);
